...
```bash
REPOSITORY          TAG                 SIZE
blacktop/logstash   latest              277MB
blacktop/logstash   6.0                 290MB
blacktop/logstash   5.6                 277MB
