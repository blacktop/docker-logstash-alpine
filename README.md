...
[![Docker Image](https://img.shields.io/badge/docker image-288.7 MB-blue.svg)](https://hub.docker.com/r/blacktop/logstash/)
...
```bash
REPOSITORY          TAG                 SIZE
blacktop/logstash   latest              288.7 MB
blacktop/logstash   5.1                 288.7 MB
